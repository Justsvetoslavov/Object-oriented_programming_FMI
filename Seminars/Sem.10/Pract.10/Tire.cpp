...
Tire::Tire(unsigned int ID, const char *manufacturer, const char *description, unsigned short width, unsigned short profile, unsigned short diameter) : CarPart(ID, manufacturer, description)
{
